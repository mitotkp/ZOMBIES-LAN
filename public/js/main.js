...
class CoreOverlays {
  constructor() {
    ...
    this.spectate = mk(`position:fixed;left:50%;top:9%;transform:translateX(-50%);z-index:30;display:none;pointer-events:none;text-align:center;color:#eee;text-shadow:0 1px 4px #000;${font}`);
